...
class FirstSampleTest(unittest.TestCase):
    ...
    def test_demo_site(self):
        ...
        try:    
            ...
            # close the app
            lambda_hooks(driver, "close the app")
            ui_action(driver = driver, operation_index = str(0))

            # click on Proverbial icon
            lambda_hooks(driver, "click on Proverbial icon")
            ui_action(driver = driver, operation_index = str(1))

            # click on 'Text' button
            lambda_hooks(driver, "click on 'Text' button")
            ui_action(driver = driver, operation_index = str(2))

            # click on Speed Test button
            lambda_hooks(driver, "click on Speed Test button")
...
if __name__ == "__main__":
    ...
    fixed_caps = {'tms.tc_id': 'TC-16', 'platformName': 'ios', 'autoAcceptAlerts': True, 'autoDismissAlerts': False}
    ...
    print("Test capabilities: {lt_options}")
